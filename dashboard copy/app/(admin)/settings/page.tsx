...
export default async function SettingsPage() {
  ...
  return (
    <div>
      ...
      <h1 className="text-2xl font-bold text-gray-900 mb-1">Réglages</h1>
      ...
      <section className="mb-10">
        <h2 className="text-base font-semibold text-gray-800 mb-3">Paramètres de l&apos;app</h2>
        ...
        <p className="text-xs text-gray-400 mt-2">
          ...
          <code className="font-mono bg-gray-100 px-1 rounded">app_settings</code>.
        </p>
      </section>

      {/* Publication des livres */}
      <section>
        <h2 className="text-base font-semibold text-gray-800 mb-3">Publication des livres</h2>
        <div className="bg-white rounded-xl border border-gray-200 overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left px-4 py-3 font-medium text-gray-600">Livre</th>
                <th className="text-center px-4 py-3 font-medium text-gray-600">Publié</th>
              </tr>
            </thead>
